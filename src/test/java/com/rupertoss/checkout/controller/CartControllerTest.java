...
public class CartControllerTest {
	...
	public void testGetCartWithPromotion() throws Exception {
		...
		String code = "10%OFF";
		Promotion promotion = getPromotionStubData();
	...
	public void testGetCartWithPromotionNoLongerValid() throws Exception {
		...
		promotion.setValidTill(new Date(System.currentTimeMillis()+24*60*60*1000));
	...
	@Test
	public void testUpdateCartInternatError() throws Exception {
		Cart cart = getCartStubData();
		Long id = new Long(1);
	...
	public Promotion getPromotionStubData() {
		Promotion promotion = new Promotion();
		promotion.setCode("10%OFF");
